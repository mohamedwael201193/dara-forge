...
const ProfilePage = () => {
  ...
  const createVerifyLink = (
    ...
    artifacts: ActivityEntry["artifacts"]
  ): string => {
  ...
  const allActivities: ActivityEntry[] = [
    // Storage activities
    ...uploadedDatasets.map(
      (item, index): ActivityEntry => ({
        kind: "storage",
        ...
        verifyLink: createVerifyLink("storage", {
          root: item.rootHash,
          tx: item.txHash,
        }),
      })
    ...
    ...chainAnchors.map(
      (item, index): ActivityEntry => ({
        ...
        verifyLink: createVerifyLink("chain", {
          root: item.rootHash,
          tx: item.txHash,
        }),
      })
    ...
    ...computeResults.map(
      (item, index): ActivityEntry => ({
        ...
        verifyLink: createVerifyLink("compute", {
          sig: item.chatID,
          root: item.rootHash,
        }),
      })
  ...
  const exportActivities = () => {
    ...
    if (exportFormat === "json") {
      ...
      // CSV export
      const csvHeaders =
        "Kind,Label,Timestamp,Root,BlobHash,DataRoot,TxHash,Signature,VerifyLink\n";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 pt-20 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-gray-400 mb-8">
            Connect your wallet to view your profile, activity history, and
            achievements
          </p>
          <ConnectWalletButton />
        </motion.div>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                {[
                  ...
                  {
                    label: "DA Publications",
                    value: daPublications.length,
                    icon: Shield,
                  },
                  {
                    label: "Chain Anchors",
                    value: chainAnchors.length,
                    icon: ExternalLink,
                  },
                  {
                    label: "Compute Jobs",
                    value: computeResults.length,
                    icon: Brain,
                  },
                ].map((stat, index) => (
                  <motion.div
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-gray-400 text-xs">
                    Your complete research journey on DARA Forge
                  </p>
                </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            <span
                              className={`px-2 py-1 rounded-full text-xs ${"bg-emerald-500/20 text-emerald-400"}`}
                            >
                              verifiable
                            </span>
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  ...
                  >
                    ...
                    {achievement.unlocked && (
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${achievement.color} opacity-5 rounded-xl`}
                      />
                    )}
