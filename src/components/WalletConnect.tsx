  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Connected to 0G Newton Testnet with address ${accounts[0].slice(0, 6)}...${accounts[0].slice(-4)}`,
      });
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {isConnected ? 'Wallet Connected' : 'Connect to 0G Chain'}
          </DialogTitle>
        </DialogHeader>
            ...
            <>
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Connect to 0G Newton Testnet to interact with DARA's decentralized features
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="p-4 border rounded-lg space-y-2">
                  <h4 className="font-medium">0G Newton Testnet</h4>
            ...
            <>
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Your wallet is connected to 0G Newton Testnet
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="p-4 border rounded-lg space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="secondary">0G Newton Testnet</Badge>
                  </div>
