...
export default function ResearchNFTSection() {
  ...
  const nftTemplates: NFTTemplate[] = [
    {
      id: "research-paper",
      title: "Research Paper iNFT",
      description: "Transform your academic research into intelligent iNFTs",
      icon: FileText,
      rarity: "Common",
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-6xl font-black mb-6">
            <span className="text-gradient">Research iNFTs</span>
          </h2>

          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Transform your research into intelligent, verifiable iNFTs on the 0G
            blockchain. From academic papers to AI models, preserve your
            intellectual property with encrypted intelligence forever.
          </p>
          ...
          >
            ...
            <code className="text-sm font-mono text-electric-blue">
              0x1234...abcd
            </code>
            <motion.button
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {nftTemplates.map((template, index) => (
            <motion.div
              key={template.id}
              className={`relative p-6 rounded-2xl border cursor-pointer transition-all duration-300 card-3d ${
                rarityStyles[template.rarity]
              } ${
            ...
            >
              ...
              <div className="absolute -top-3 -right-3">
                <div
                  className={`px-3 py-1 rounded-full text-xs font-bold ${template.color} bg-black/80 border border-current/20`}
                >
                  {template.rarity}
                </div>
              </div>
              ...
              {/* Icon */}
              <div
                className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${template.bgGradient} mb-4`}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Join the future of research publication. Create tamper-proof,
                verifiable records of your work that can be cited, traded, and
                preserved forever.
              </p>
