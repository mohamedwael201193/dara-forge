            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  Decentralized AI Research Assistant
                </p>
              </div>
            </div>
            <ConnectWalletButton />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <p className="text-xs text-blue-100">
                Decentralized file storage with cryptographic proofs
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <p className="text-xs text-blue-100">
                Intelligent dataset summarization and insights
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <p className="text-xs text-blue-100">
                Share research findings across decentralized networks
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <p className="text-xs text-blue-100">
                Immutable verification and integrity tracking
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="mt-8">
              ...
              <TabsContent value="summarize" className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-300 max-w-2xl mx-auto">
                    Generate intelligent summaries and insights from your
                    datasets using advanced AI models. Extract key findings,
                    patterns, and research-relevant information automatically.
                  </p>
                </div>
                <AISummarizeSection />
              </TabsContent>
              ...
              <TabsContent value="publish" className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-300 max-w-2xl mx-auto">
                    Publish your research findings and datasets to decentralized
                    networks for global accessibility. Ensure your work reaches
                    the global research community through distributed channels.
                  </p>
                </div>
                <DAPublish />
              </TabsContent>
              ...
              <TabsContent value="nfts" className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-300 max-w-2xl mx-auto">
                    Transform your scientific achievements into intelligent NFTs
                    with encrypted AI capabilities. Mint iNFTs for research
                    milestones, dataset ownership, and peer review contributions
                    with complete 0G verification.
                  </p>
                </div>
                <NFTsComingSoon />
              </TabsContent>
              ...
              <TabsContent value="activity" className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-300 max-w-2xl mx-auto">
                    Track all your uploads, DA publications, AI analyses, and
                    blockchain transactions in one place. Monitor the complete
                    workflow of your research data through the 0G ecosystem.
                  </p>
                </div>
                <ActivityHistory />
              </TabsContent>
              ...
              <TabsContent value="status" className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-300 max-w-2xl mx-auto">
                    Monitor your wallet connection, 0G balance, and network
                    status. Ensure you're connected to the correct 0G Chain for
