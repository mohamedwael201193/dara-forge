...
export const UploadDataset: React.FC<UploadDatasetProps> = () => {
  ...
  const [activeTab, setActiveTab] = useState<'compute' | 'da'>('compute')
      ...
      {uploadedDatasets.length > 0 && (
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription className="text-slate-300">
              Select a dataset to run 0G Compute jobs or publish to Data Availability
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-slate-300">
                  Run AI analysis or publish to Data Availability Network
                </CardDescription>
              </div>
