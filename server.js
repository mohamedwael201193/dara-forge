...
// ==================== MINT ENDPOINT (Gasless iNFT Minting) ====================
...
app.post('/api/mint', async (req, res) => {
  ...
  try {
    ...
    const receipt = await tx.wait();
    console.log('[Mint API] Transaction confirmed in block:', receipt.blockNumber);
    ...
    if (!tokenId) {
      ...
      console.log('[Mint API] Could not parse token ID from logs, using fallback:', tokenId);
    }
